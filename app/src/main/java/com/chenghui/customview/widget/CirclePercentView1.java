...
public class CirclePercentView1 extends View {
    ...
    public CirclePercentView1(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CirclePercentView1(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                for (int i = 0; i < mPercent; i++) {
                    ...
                    mCurPercent = i;
                    CirclePercentView1.this.postInvalidate();
                }
            }
